...
namespace UniOSC{
	...
	/// </summary>
	[AddComponentMenu("UniOSC/EventDispatcherButtonSC")]
	[ExecuteInEditMode]
	public class UniOSCEventDispatcherButtonSC: UniOSCEventDispatcher {
       
        #region public
        [SerializeField]
        public bool OnlyOneKey = false;
        // soundcool
        //[SerializeField]
        ...
        static UniOSCEventDispatcherButtonSC ActiveScriptSC;
        ...
        public void SendOSCMessageDown(){
            ...
            if (OnlyOneKey)
            {
                this.transform.parent.parent.BroadcastMessage("SpreadSendOSCMessageUp");
            }
        ...
        public void SpreadSendOSCMessageUp_OP()
        {
            //SendOSCMessageUp();
            ActiveScriptSC = null;
            ...
            //Debug.Log("funcion SpreadSendOSCMessageUp_OP");
        }
        ...
        //SC 2
        public void SpreadSendOSCMessageUp()
        {
            if (ActiveScriptSC != this)
            {
                SendOSCMessageUp();
                GetComponent<Animator>().SetTrigger("Normal");
            }
            //Debug.Log("funcion SpreadSendOSCMessageUp");
        }
        //SC 2 end
