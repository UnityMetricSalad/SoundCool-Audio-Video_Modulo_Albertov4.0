...
namespace UniOSC{
	...
	/// </summary>
	[AddComponentMenu("UniOSC/SoundCool_UniOSCConnection")]
	[ExecuteInEditMode]
	[Serializable]
	public class UniOSCConnection : MonoBehaviour {
       ...
       // [Range(0, UniOSCUtils.MAXPORT)]
        ...
        //SC 1 Cargamos la nueva IP introducida en el recuadro de texto destinado para ello          
        public void sc_changeoscOutIPAddress(string newoscOutIPAddress)
        {

            oscOutIPAddress = newoscOutIPAddress;
            statics.IP = oscOutIPAddress;
    }
		//SC 1 FIN
        ...
        public string oscOutIPAddress
        {
            get { 
               ...
               // return _oscOutIPAddress;
				// comprobacion del metodo de transmision utilizado para el envio de datos
                string ip = null;
        ...
        //SC 2 comprobación de que la IP introducida es correcta
        public bool SC_ValidateOscOutIPAddress(string ipadress)
        {
            IPAddress addr;
            _isValidOscOutIPAddress = UniOSCUtils.ValidateIPAddress(_oscOutIPAddress, out addr);
            _oscOutIPAddressAsIPAddress = addr;
            return _isValidOscOutIPAddress;
        }
        //SC 2 FIN
        ...
        public void ValidateOscOutIPAddress()
        {
         ...
         public bool hasValidOscOutIPAddress{
          ...
          //SC 3 introduccion y comprobacion del puerto de conexion asignado a la IP          
       public void sc_changePort(string newPort)
        {
            int lastgoodport = oscOutPort;
            try
            {
            oscOutPort = Int32.Parse(newPort);
                statics.PORT = oscOutPort;
            }
            catch (Exception e) { oscOutPort = 0; statics.PORT = lastgoodport; }
...
//		}
		...
		public void SendOSCMessage(object sender,UniOSCEventArgs args){
            ...
            //-------------SOUNDCOOL
			// se puso vibracion como animacion en el testeo de la conexion
